...
class CNNCL_AM(nn.Module):
    """
    CNN model with Contrastive Learning and Attention Mechanism
    """
...
class TextClassifier:
    ...
    def save_contrastive_model(self, save_path="cnn-am-contrastive_model.pt"):
        ...
        # 保存模型参数
        state_dict = {
            'cl_encoder': self.cl_encoder.state_dict(),  # 仅保存BERT
    ...
    def _build_retrieval_index(self, train_texts, train_labels):
        ...
        # Build the index
        self.annoy_index.build(15)  # 10 trees for better accuracy
    ...
    def train_classifier(self, train_texts, train_labels, val_texts, val_labels,epochs=None,batch_size=64,save_path="cnn-am-best_model.pth"):
        # 使用类参数作为默认值
        if epochs is None:
...
if __name__ == "__main__":
    ...
    # 定义对比学习模型保存路径
    contrastive_model_path = "./nobertmodels/cnn-am-best-contrastive_model.pt"
    ...
    # Train classifier with attention mechanism
    ...
    classifier.train_classifier(
        ...
        epochs=10,
        batch_size=32,
        save_path="cnn-am-ecu-best.pth"
    )

    # Evaluate on test set
    print("Evaluating on test set...")
    precision, recall, f1 = classifier.evaluate(X_test_sampled, y_test_sampled, model_path="cnn-am-ecu-best.pth")
